<fieldset class="col-group required <?php echo (is_array($form_errors['gcs_access_key']) ? 'invalid' : ''); ?>">
...
<fieldset class="col-group required <?php echo (is_array($form_errors['gcs_secret_key']) ? 'invalid' : ''); ?>">
	<div class="setting-txt col w-8">
